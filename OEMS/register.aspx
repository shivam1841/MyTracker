...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width:50%;" align="center" border="0" bgcolor="#E4BA1E">
        ...
        <tr>
            <td class="auto-style3" align="center" colspan="3">
                &nbsp;<strong><asp:Label ID="Label18" runat="server" Font-Bold="False" Font-Names="Forte" Font-Size="13pt" Text="Personal Details"></asp:Label>
                </strong>
            </td>
        </tr>
        <tr>
